					...
					<div class="neirong clr">
						<table cellpadding="0" cellspacing="0" class="table clr">
							...
							<tr>
								...
								<td>
									<a data-class="btn-warm" class="json <?php echo $isstate==1?'':'btn-warm' ?>" data-url="s=1&a=isstate&t=<?php echo $table?>&id=<?php echo $id?>"><?php echo config('webarr.isstate')[$isstate] ?></a>
								</td>
								<td><?php echo $time?></td>
